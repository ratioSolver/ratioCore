...
namespace ratio::core
{
  ...
  public:
    ORATIOCORE_EXPORT constructor(type &tp, std::vector<field_ptr> args, std::vector<riddle::id_token> ins, std::vector<std::vector<std::unique_ptr<const riddle::ast::expression>>> ivs, const std::vector<std::unique_ptr<const riddle::ast::statement>> &stmnts);
