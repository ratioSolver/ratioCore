...
namespace ratio::core
{
  ...
  public:
    ...
    inline const std::vector<const field *> &get_args() const noexcept { return args; } // returns the list of arguments of this predicate..
  ...
  private:
    std::vector<const field *> args;                                              // the arguments of this predicate..
